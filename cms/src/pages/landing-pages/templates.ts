...
export const PAGE_TEMPLATES: PageTemplate[] = [
  ...
  // ─── Trang chính ───────────────────────────────────
  {
    ...
    page: {
      slug: 'trang-chu',
      path: '/',
      title: 'Phòng khám – Chăm sóc chuyên nghiệp',
      description: 'Mẫu trang giới thiệu đội ngũ chuyên môn, dịch vụ và không gian của phòng khám.',
      seoTitle: 'Phòng khám – Dịch vụ chuyên nghiệp',
      seoDescription: 'Mẫu nội dung giới thiệu các dịch vụ chăm sóc và điều trị của phòng khám.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: 'Vẻ đẹp tự nhiên – Sự tự tin vượt trội', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 7, order: 2, text: 'Phòng khám của bạn – nơi hội tụ đội ngũ chuyên môn, công nghệ phù hợp và dịch vụ tận tâm. Hãy thay nội dung mẫu này bằng thông tin thương hiệu của bạn.', align: 'left' },
        { id: makeId(), type: 'image', row: 2, span: 5, order: 3, url: '', alt: 'Cơ sở phòng khám', caption: 'Cơ sở phòng khám' },
  ...
  },
  {
    ...
    page: {
      ...
      description: 'Mẫu trang giới thiệu lịch sử, đội ngũ và định hướng phát triển của phòng khám.',
      seoTitle: 'Giới thiệu phòng khám',
      seoDescription: 'Mẫu nội dung SEO giới thiệu phòng khám và đội ngũ chuyên môn.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: 'Câu chuyện của phòng khám', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 7, order: 2, text: 'Hãy thay phần này bằng lịch sử hình thành, đội ngũ lãnh đạo, chuyên môn và triết lý phục vụ của phòng khám. Nội dung mẫu không đại diện cho bất kỳ thương hiệu nào.', align: 'left' },
        { id: makeId(), type: 'image', row: 2, span: 5, order: 3, url: '', alt: 'Cơ sở phòng khám', caption: 'Cơ sở chính' },
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Đội ngũ bác sĩ',
      seoDescription: 'Mẫu nội dung giới thiệu đội ngũ bác sĩ và chuyên viên của phòng khám.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: 'Đội ngũ chuyên gia hàng đầu', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 12, order: 2, text: 'Hãy thay phần này bằng thông tin chuyên môn, kinh nghiệm và triết lý phục vụ của đội ngũ phòng khám.', align: 'center' },
        { id: makeId(), type: 'title', row: 3, span: 12, order: 3, title: 'Gặp gỡ các chuyên gia', level: 2, align: 'center' },
        { id: makeId(), type: 'image', row: 4, span: 3, order: 4, url: '', alt: 'Bác sĩ', caption: 'Bác sĩ phụ trách' },
        ...
        { id: makeId(), type: 'text', row: 5, span: 3, order: 11, text: '🎓 Đại học Y Dược TP.HCM\n🇰🇷 Chứng chỉ Allergan Master\n✨ Chuyên: Filler, Botox, trẻ hóa\n📌 Kinh nghiệm: 7 năm', align: 'left' },
        {
          ...
          fields: [
            ...
            { id: makeId(), name: 'phone', label: 'Số điện thoại', type: 'tel' as const, placeholder: '0901 234 567', required: true, span: 6 },
            { id: makeId(), name: 'doctor', label: 'Bác sĩ mong muốn', type: 'text' as const, placeholder: 'Ví dụ: Bác sĩ phụ trách', required: false, span: 6 },
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Liên hệ phòng khám',
      seoDescription: 'Mẫu nội dung liên hệ; hãy thay bằng hotline và địa chỉ của phòng khám.',
      isPublished: false,
      blocks: [
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Đặt lịch khám',
      seoDescription: 'Mẫu trang đặt lịch tư vấn tại phòng khám.',
      isPublished: false,
      blocks: [
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Kết quả thực tế trước & sau',
      seoDescription: 'Mẫu trang trưng bày kết quả điều trị thực tế.',
      isPublished: false,
      blocks: [
        ...
        { id: makeId(), type: 'text', row: 8, span: 4, order: 12, text: '"Hãy thay đánh giá mẫu này bằng phản hồi đã được khách hàng cho phép công bố."', align: 'left' },
  ...
  // ─── Dịch vụ cụ thể ────────────────────────────────
  {
    ...
    page: {
      ...
      seoTitle: 'Nâng mũi cấu trúc',
      seoDescription: 'Mẫu nội dung SEO cho dịch vụ nâng mũi.',
      isPublished: false,
      blocks: [
        ...
        { id: makeId(), type: 'video', row: 3, span: 12, order: 4, url: '', title: 'Quy trình nâng mũi cấu trúc' },
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Căng da mặt không phẫu thuật',
      seoDescription: 'Mẫu nội dung SEO cho dịch vụ căng da mặt.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: 'Trẻ hơn 10 tuổi – Không dao kéo', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 12, order: 2, text: 'Hãy thay nội dung mẫu này bằng mô tả dịch vụ, chỉ định và thông tin chuyên môn đã được phê duyệt.', align: 'center' },
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Độn cằm V-Line',
      seoDescription: 'Mẫu nội dung SEO cho dịch vụ độn cằm.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: 'Độn cằm V-Line – Khuôn mặt hoàn hảo', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 7, order: 2, text: 'Hãy thay nội dung mẫu này bằng mô tả dịch vụ và thông tin chuyên môn phù hợp với phòng khám.', align: 'left' },
        { id: makeId(), type: 'image', row: 2, span: 5, order: 3, url: '', alt: 'Kết quả độn cằm', caption: 'Kết quả thực tế – 2 tháng sau độn cằm V-Line' },
        { id: makeId(), type: 'video', row: 3, span: 12, order: 4, url: '', title: 'Quy trình phẫu thuật độn cằm' },
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Tiêm Filler & Botox',
      seoDescription: 'Mẫu nội dung SEO cho dịch vụ tiêm thẩm mỹ.',
      isPublished: false,
      blocks: [
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Điều trị mụn chuyên sâu',
      seoDescription: 'Mẫu nội dung SEO cho dịch vụ điều trị mụn.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: 'Điều trị mụn tận gốc – Sẹo không còn là nỗi lo', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 12, order: 2, text: 'Hãy thay nội dung mẫu này bằng thông tin dịch vụ và hướng dẫn chuyên môn đã được phê duyệt.', align: 'center' },
        ...
        { id: makeId(), type: 'video', row: 5, span: 12, order: 7, url: '', title: 'Quy trình điều trị mụn' },
  ...
  // ─── Campaign ──────────────────────────────────────
  {
    ...
    page: {
      ...
      seoTitle: 'Ưu đãi dịch vụ',
      seoDescription: 'Mẫu trang ưu đãi dịch vụ; hãy cập nhật theo chính sách hiện hành.',
      isPublished: false,
      blocks: [
        { id: makeId(), type: 'title', row: 1, span: 12, order: 1, title: '🎉 Ưu đãi đặc biệt tháng 7 – Giảm đến 30%', level: 1, align: 'center' },
        { id: makeId(), type: 'text', row: 2, span: 12, order: 2, text: 'Hãy thay nội dung mẫu bằng chương trình ưu đãi đã được phê duyệt của phòng khám.', align: 'center' },
  ...
  },
  {
    ...
    page: {
      ...
      seoTitle: 'Tư vấn dịch vụ',
      seoDescription: 'Mẫu nội dung SEO cho trang tư vấn dịch vụ.',
      isPublished: false,
      blocks: [
        ...
        { id: makeId(), type: 'title', row: 4, span: 12, order: 4, title: 'Vì sao chọn phòng khám?', level: 2, align: 'center' },
