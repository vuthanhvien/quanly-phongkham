...
export function PayrollsPage() {
  ...
  const columns = [
    ...
    { title: "Lương cơ bản", dataIndex: "baseSalary", key: "base", render: fmt, width: 160, align: "right" as const },
    { title: "Ngày công", key: "days", render: (_: unknown, r: Payroll) => `${r.actualDays}/${r.workingDays}`, width: 120, align: "right" as const },
    { title: "Khấu trừ", dataIndex: "deduction", key: "deduction", render: fmt, width: 140, align: "right" as const },
    { title: "Thưởng", dataIndex: "bonus", key: "bonus", render: fmt, width: 130, align: "right" as const },
    {
      title: "Thực lãnh",
      dataIndex: "netSalary",
      key: "net",
