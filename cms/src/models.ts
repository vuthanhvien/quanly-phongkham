...
const rawBaseFields: Record<string, FieldSpec[]> = {
  ...
  'stock-batches': [
    { key: 'movementType', label: 'Loại phiếu', type: 'select', required: true, defaultValue: 'IMPORT', options: [{ value: 'IMPORT', label: 'Phiếu nhập kho' }, { value: 'EXPORT', label: 'Phiếu xuất kho' }, { value: 'RETURN', label: 'Phiếu hoàn kho' }, { value: 'WASTE', label: 'Phiếu hao hụt / hủy' }], width: '33', tableWidth: 150 },
    ...
    { key: 'branchId', label: 'Chi nhánh', required: true, width: '50', tableWidth: 190 },
    { key: 'storageLocation', label: 'Vị trí kho / phòng', width: '50', tableWidth: 190 },
