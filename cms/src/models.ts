...
const RESOURCE_HIDDEN_FIELD_KEYS: Record<string, string[]> = {
  ...
  products: ['excerpt', 'content', 'isFeatured'],
...
export interface FieldSpec {
  ...
  tab?: string;
  type?: 'text' | 'number' | 'date' | 'datetime' | 'select' | 'multi-select' | 'checkbox' | 'textarea' | 'html' | 'relative' | 'file' | 'video' | 'image' | 'images' | 'dynamic-table' | 'table' | 'combo' | 'service-order-items';
...
const defaultFieldTabs: Record<string, Record<string, string>> = {
  ...
  'medical-episodes': { customerId: 'Thông tin hồ sơ', branchId: 'Thông tin hồ sơ', visitId: 'Liên kết ca khám', serviceName: 'Thông tin hồ sơ', doctorName: 'Thông tin hồ sơ', status: 'Thông tin hồ sơ', chiefComplaint: 'Chuyên môn', allergyWarning: 'Chuyên môn', diagnosis: 'Chuyên môn', operationDate: 'Chuyên môn' },
  appointments: { customerId: 'Lịch hẹn', branchId: 'Lịch hẹn', visitId: 'Liên kết ca khám', type: 'Lịch hẹn', startTime: 'Lịch hẹn', endTime: 'Lịch hẹn', status: 'Lịch hẹn', doctorStaffId: 'Nguồn lực', roomId: 'Nguồn lực', equipmentId: 'Nguồn lực', picStaffId: 'Nguồn lực' },
  'patient-visits': { code: 'Thông tin ca khám', customerId: 'Thông tin ca khám', branchId: 'Thông tin ca khám', appointmentId: 'Nguồn gốc', treatmentId: 'Liên kết liệu trình', visitedAt: 'Thông tin ca khám', type: 'Thông tin ca khám', status: 'Thông tin ca khám', doctorStaffId: 'Nguồn lực', roomId: 'Nguồn lực', note: 'Ghi chú' },
  ...
  consultations: { customerId: 'Thông tin thăm khám', branchId: 'Thông tin thăm khám', visitId: 'Liên kết ca khám', consultedAt: 'Thông tin thăm khám', consultantStaffId: 'Thông tin thăm khám', doctorStaffId: 'Thông tin thăm khám', status: 'Thông tin thăm khám', summary: 'Kết quả chuyên môn', diagnosis: 'Kết quả chuyên môn', nextAction: 'Kết quả chuyên môn' },
  'service-orders': { code: 'Thông tin đơn', customerId: 'Thông tin đơn', branchId: 'Thông tin đơn', visitId: 'Liên kết ca khám', orderDate: 'Thông tin đơn', serviceName: 'Dịch vụ & giá', quantity: 'Dịch vụ & giá', unitPrice: 'Dịch vụ & giá', totalAmount: 'Dịch vụ & giá', performerStaffId: 'Thực hiện', status: 'Thực hiện', note: 'Ghi chú' },
  'customer-images': { customerId: 'Thông tin', branchId: 'Thông tin', visitId: 'Liên kết ca khám', mediaType: 'Thông tin', title: 'Thông tin', capturedAt: 'Thông tin', imageUrl: 'Hình ảnh', files: 'Hình ảnh', diagnosisNote: 'Ghi chú chuyên môn' },
  invoices: { code: 'Thông tin phiếu thu', customerId: 'Thông tin phiếu thu', branchId: 'Thông tin phiếu thu', visitId: 'Liên kết ca khám', status: 'Thông tin phiếu thu', taxableAmount: 'Thuế & tổng tiền', vatRate: 'Thuế & tổng tiền', vatAmount: 'Thuế & tổng tiền', totalAmount: 'Thuế & tổng tiền', paidAmount: 'Thanh toán', method: 'Thanh toán', paymentAccountNumber: 'Thanh toán', revenueAccountNumber: 'Hạch toán' },
  treatments: { customerId: 'Thông tin liệu trình', branchId: 'Thông tin liệu trình', visitId: 'Liên kết ca khám', name: 'Thông tin liệu trình', totalSessions: 'Tiến độ', completedSessions: 'Tiến độ', intervalDays: 'Tiến độ', status: 'Tiến độ' },
...
export const entityLabels: Record<string, string> = {
  ...
  warehouses: 'Kho hàng',
  'recruitment-positions': 'Vị trí tuyển dụng',
  candidates: 'Ứng viên',
  'candidate-applications': 'Hồ sơ ứng tuyển',
  'recruitment-interviews': 'Lịch phỏng vấn',
  'recruitment-scorecards': 'Scorecard phỏng vấn',
  'recruitment-offers': 'Đề nghị tuyển dụng',
  'asset-categories': 'Danh mục tài sản',
  assets: 'Tài sản',
  'asset-movements': 'Phiếu tài sản',
  'asset-maintenances': 'Bảo trì tài sản',
  ...
  'software-licenses': 'Gói bản quyền phần mềm',
  'software-license-assignments': 'Cấp phát bản quyền',
...
export const relationFields: Record<string, RelationSpec> = {
  ...
  warehouseId: { resource: 'warehouses', labelFields: ['code', 'name'] },
  destinationWarehouseId: { resource: 'warehouses', labelFields: ['code', 'name'] },
  destinationBranchId: { resource: 'branches', labelFields: ['slug', 'name'] },
  candidateId: { resource: 'candidates', labelFields: ['code', 'fullName'] },
  recruitmentPositionId: { resource: 'recruitment-positions', labelFields: ['code', 'name'] },
  candidateApplicationId: { resource: 'candidate-applications', labelFields: ['id'] },
  recruitmentInterviewId: { resource: 'recruitment-interviews', labelFields: ['scheduledAt'] },
  ...
  appointmentId: { resource: 'appointments', labelFields: ['startTime', 'type'] },
  treatmentId: { resource: 'treatments', labelFields: ['name', 'status'] },
  visitId: { resource: 'patient-visits', labelFields: ['code', 'visitedAt', 'type'] },
  ...
  softwareLicenseId: { resource: 'software-licenses', labelFields: ['code', 'name', 'provider'] },
  ...
  hiringManagerId: { resource: 'staff', labelFields: ['code', 'fullName'] },
  interviewerStaffIds: { resource: 'staff', labelFields: ['code', 'fullName'] },
  assetCategoryId: { resource: 'asset-categories', labelFields: ['code', 'name'] },
  assetId: { resource: 'assets', labelFields: ['code', 'name'] },
  custodianStaffId: { resource: 'staff', labelFields: ['code', 'fullName'] },
  fromBranchId: { resource: 'branches', labelFields: ['slug', 'name'] },
  fromWarehouseId: { resource: 'warehouses', labelFields: ['code', 'name'] },
  fromRoomId: { resource: 'rooms', labelFields: ['code', 'name'] },
  fromCustodianStaffId: { resource: 'staff', labelFields: ['code', 'fullName'] },
  toBranchId: { resource: 'branches', labelFields: ['slug', 'name'] },
  toWarehouseId: { resource: 'warehouses', labelFields: ['code', 'name'] },
  toRoomId: { resource: 'rooms', labelFields: ['code', 'name'] },
  toCustodianStaffId: { resource: 'staff', labelFields: ['code', 'fullName'] },
...
const rawBaseFields: Record<string, FieldSpec[]> = {
  ...
  products: [
    ...
    { key: 'productType', label: 'Loại', type: 'select', options: [{ value: 'CONSUMABLE', label: 'Vật tư tiêu hao' }, { value: 'REUSABLE', label: 'Thiết bị tái dùng' }, { value: 'RETAIL', label: 'Sản phẩm bán lẻ' }, { value: 'SERVICE', label: 'Dịch vụ' }, { value: 'COMBO', label: 'Combo / Gói dịch vụ' }], defaultValue: 'CONSUMABLE', width: '33', tableWidth: 150 },
    ...
    { key: 'bundleItems', label: 'Thành phần combo', type: 'combo', width: '100', tableWidth: 320 },
    { key: 'picId', label: 'Người phụ trách', width: '50', tableWidth: 220 },
  ],
  units: [
  ...
  'patient-visits': [
    { key: 'code', label: 'Mã ca khám', width: '33', tableWidth: 150 },
    { key: 'customerId', label: 'Khách hàng', required: true, width: '50', tableWidth: 220 },
    { key: 'branchId', label: 'Chi nhánh', required: true, width: '50', tableWidth: 190 },
    { key: 'appointmentId', label: 'Booking nguồn', width: '50', tableWidth: 190 },
    { key: 'treatmentId', label: 'Thuộc liệu trình', width: '50', tableWidth: 220 },
    { key: 'visitedAt', label: 'Thời điểm đến khám', type: 'datetime', required: true, width: '50', tableWidth: 190 },
    { key: 'type', label: 'Loại ca khám', type: 'select', defaultValue: 'CONSULTATION', options: [{ value: 'CONSULTATION', label: 'Khám / tư vấn' }, { value: 'TREATMENT', label: 'Điều trị' }, { value: 'SURGERY', label: 'Ca mổ' }, { value: 'FOLLOW_UP', label: 'Tái khám' }], width: '33', tableWidth: 160 },
    { key: 'status', label: 'Trạng thái', type: 'select', defaultValue: 'CHECKED_IN', options: [{ value: 'CHECKED_IN', label: 'Đã check-in' }, { value: 'IN_PROGRESS', label: 'Đang thực hiện' }, { value: 'COMPLETED', label: 'Hoàn thành' }, { value: 'CANCELLED', label: 'Đã hủy' }], width: '33', tableWidth: 150 },
  ...
  'software-licenses': [
    { key: 'code', label: 'Mã gói', disabled: true, width: '25', tableWidth: 130 },
    { key: 'name', label: 'Tên phần mềm / gói', required: true, width: '50', tableWidth: 220, placeholder: 'Ví dụ: Microsoft 365 Business Standard' },
    { key: 'provider', label: 'Nhà cung cấp', required: true, width: '33', tableWidth: 170, placeholder: 'Microsoft, Adobe, Figma...' },
    { key: 'plan', label: 'Gói / Edition', width: '33', tableWidth: 180 },
    { key: 'seatCount', label: 'Số seat đã mua', type: 'number', required: true, defaultValue: 1, width: '25', tableWidth: 140 },
    { key: 'usedSeats', label: 'Đã cấp', type: 'number', disabled: true, width: '25', tableWidth: 110 },
    { key: 'availableSeats', label: 'Còn trống', type: 'number', disabled: true, width: '25', tableWidth: 120 },
    { key: 'cost', label: 'Chi phí', type: 'number', width: '25', tableWidth: 140 },
    { key: 'currency', label: 'Tiền tệ', type: 'select', options: [{ value: 'VND', label: 'VND' }, { value: 'USD', label: 'USD' }], defaultValue: 'VND', width: '25', tableWidth: 110 },
    { key: 'purchasedAt', label: 'Ngày mua', type: 'date', width: '33', tableWidth: 145 },
    { key: 'renewalDate', label: 'Ngày gia hạn / hết hạn', type: 'date', width: '33', tableWidth: 180 },
    { key: 'status', label: 'Trạng thái', type: 'select', options: [{ value: 'ACTIVE', label: 'Đang hoạt động' }, { value: 'EXPIRED', label: 'Hết hạn' }, { value: 'CANCELLED', label: 'Đã hủy' }], defaultValue: 'ACTIVE', width: '33', tableWidth: 150 },
    { key: 'contractNumber', label: 'Số hợp đồng / hóa đơn', width: '50', tableWidth: 200 },
    { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
    { key: 'picId', label: 'Người phụ trách', width: '50', tableWidth: 220 },
  ],
  'software-license-assignments': [
    { key: 'softwareLicenseId', label: 'Gói bản quyền', required: true, width: '50', tableWidth: 250 },
    { key: 'staffId', label: 'Nhân viên', required: true, width: '50', tableWidth: 220 },
    { key: 'accountEmail', label: 'Email tài khoản được cấp', width: '50', tableWidth: 240, placeholder: 'email dùng tại Microsoft / Adobe / Figma' },
    { key: 'assignedAt', label: 'Ngày cấp', type: 'date', required: true, width: '33', tableWidth: 150 },
    { key: 'revokedAt', label: 'Ngày thu hồi', type: 'date', width: '33', tableWidth: 150 },
    { key: 'status', label: 'Trạng thái', type: 'select', options: [{ value: 'PENDING', label: 'Chờ gửi duyệt' }, { value: 'PENDING_MANAGER', label: 'Chờ Leader duyệt' }, { value: 'PENDING_IT', label: 'Chờ IT/Admin cấp' }, { value: 'ACTIVE', label: 'Đang sử dụng' }, { value: 'REVOKED', label: 'Đã thu hồi' }, { value: 'REJECTED', label: 'Từ chối' }, { value: 'CANCELLED', label: 'Đã hủy' }], defaultValue: 'PENDING', width: '33', tableWidth: 170 },
    { key: 'note', label: 'Ghi chú / lý do thu hồi', type: 'textarea', width: '100', tableWidth: 320 },
    { key: 'picId', label: 'Người phụ trách', width: '50', tableWidth: 220 },
  ],
  'performance-reviews': [
    { key: 'staffId', label: 'Nhân viên', required: true, width: '50', tableWidth: 220 },
  ...
  'workflow-definitions': [
    ...
    { key: 'targetResource', label: 'Model áp dụng', type: 'select', options: [
      ...
      { value: 'software-license-assignments', label: 'Cấp phát bản quyền phần mềm' },
  ...
  'service-orders': [
    ...
    { key: 'items', label: 'Danh sách sản phẩm / dịch vụ', type: 'service-order-items', required: true, defaultValue: [{ quantity: 1 }], width: '100', tableWidth: 420 },
  ...
  'stock-batches': [
    { key: 'movementType', label: 'Loại phiếu', type: 'select', required: true, defaultValue: 'IMPORT', options: [{ value: 'IMPORT', label: 'Phiếu nhập kho' }, { value: 'EXPORT', label: 'Phiếu xuất kho' }, { value: 'TRANSFER', label: 'Phiếu chuyển kho' }, { value: 'RETURN', label: 'Phiếu hoàn kho' }, { value: 'WASTE', label: 'Phiếu hao hụt / hủy' }], width: '33', tableWidth: 150 },
    { key: 'code', label: 'Mã phiếu', width: '33', tableWidth: 150 },
    { key: 'movementDate', label: 'Ngày phiếu', type: 'date', required: true, width: '33', tableWidth: 150 },
    { key: 'branchId', label: 'Chi nhánh', required: true, width: '50', tableWidth: 190 },
    { key: 'warehouseId', label: 'Kho nguồn / kho nhập', required: true, width: '50', tableWidth: 210 },
    { key: 'destinationBranchId', label: 'Chi nhánh đích', width: '50', tableWidth: 190 },
    { key: 'destinationWarehouseId', label: 'Kho đích', width: '50', tableWidth: 210 },
    { key: 'procedureReference', label: 'Mã ca / hồ sơ điều trị', width: '50', tableWidth: 190 },
    { key: 'supplierId', label: 'Nhà cung cấp', width: '50', tableWidth: 220 },
    { key: 'items', label: 'Danh sách sản phẩm', type: 'service-order-items', required: true, defaultValue: [{ quantity: 1 }], width: '100', tableWidth: 420 },
    { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
    { key: 'picId', label: 'Người phụ trách', width: '50', tableWidth: 220 },
  ],
  warehouses: [
    { key: 'code', label: 'Mã kho', required: true, width: '33', tableWidth: 150 },
    { key: 'name', label: 'Tên kho', required: true, width: '50', tableWidth: 240 },
    { key: 'branchId', label: 'Chi nhánh', required: true, width: '50', tableWidth: 190 },
    { key: 'address', label: 'Vị trí / địa chỉ', width: '66', tableWidth: 260 },
    { key: 'isActive', label: 'Đang sử dụng', type: 'checkbox', defaultValue: true, width: '33', tableWidth: 150 },
    { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'recruitment-positions': [
    { key: 'code', label: 'Mã vị trí', required: true, width: '33', tableWidth: 150 }, { key: 'name', label: 'Vị trí tuyển', required: true, width: '50', tableWidth: 240 }, { key: 'branchId', label: 'Chi nhánh', width: '50', tableWidth: 180 }, { key: 'departmentId', label: 'Phòng ban', width: '50', tableWidth: 180 }, { key: 'hiringManagerId', label: 'Quản lý tuyển', width: '50', tableWidth: 200 }, { key: 'headcount', label: 'Số lượng', type: 'number', defaultValue: 1, width: '25', tableWidth: 120 }, { key: 'salaryMin', label: 'Lương từ', type: 'number', width: '33', tableWidth: 150 }, { key: 'salaryMax', label: 'Lương đến', type: 'number', width: '33', tableWidth: 150 }, { key: 'status', label: 'Trạng thái', type: 'select', defaultValue: 'OPEN', options: [{ value: 'OPEN', label: 'Đang tuyển' }, { value: 'PAUSED', label: 'Tạm dừng' }, { value: 'CLOSED', label: 'Đã đóng' }], width: '33', tableWidth: 140 }, { key: 'description', label: 'Mô tả công việc', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  candidates: [
    { key: 'code', label: 'Mã ứng viên', required: true, width: '33', tableWidth: 150 }, { key: 'fullName', label: 'Họ tên', required: true, width: '50', tableWidth: 220 }, { key: 'phone', label: 'Điện thoại', width: '33', tableWidth: 160 }, { key: 'email', label: 'Email', width: '50', tableWidth: 220 }, { key: 'source', label: 'Nguồn', type: 'select', options: [{ value: 'JOB_BOARD', label: 'Trang tuyển dụng' }, { value: 'REFERRAL', label: 'Giới thiệu' }, { value: 'FACEBOOK', label: 'Facebook' }, { value: 'WALK_IN', label: 'Ứng tuyển trực tiếp' }, { value: 'OTHER', label: 'Khác' }], width: '33', tableWidth: 160 }, { key: 'expectedSalary', label: 'Lương mong muốn', type: 'number', width: '33', tableWidth: 170 }, { key: 'cvUrl', label: 'Link CV', width: '66', tableWidth: 260 }, { key: 'status', label: 'Trạng thái', type: 'select', defaultValue: 'ACTIVE', options: [{ value: 'ACTIVE', label: 'Đang xử lý' }, { value: 'HIRED', label: 'Đã tuyển' }, { value: 'REJECTED', label: 'Không phù hợp' }], width: '33', tableWidth: 150 }, { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'candidate-applications': [
    { key: 'candidateId', label: 'Ứng viên', required: true, width: '50', tableWidth: 220 }, { key: 'recruitmentPositionId', label: 'Vị trí tuyển', required: true, width: '50', tableWidth: 220 }, { key: 'stage', label: 'Pipeline', type: 'select', defaultValue: 'NEW', options: [{ value: 'NEW', label: 'Mới' }, { value: 'SCREENING', label: 'Sàng lọc' }, { value: 'INTERVIEW_1', label: 'Phỏng vấn vòng 1' }, { value: 'SPECIALIST', label: 'Phỏng vấn chuyên môn' }, { value: 'OFFER', label: 'Đề nghị tuyển' }, { value: 'HIRED', label: 'Đạt' }, { value: 'REJECTED', label: 'Không đạt' }], width: '33', tableWidth: 180 }, { key: 'appliedAt', label: 'Ngày ứng tuyển', type: 'date', width: '33', tableWidth: 150 }, { key: 'ownerStaffId', label: 'Người phụ trách', width: '50', tableWidth: 200 }, { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'recruitment-interviews': [
    { key: 'candidateApplicationId', label: 'Hồ sơ ứng tuyển', required: true, width: '50', tableWidth: 240 }, { key: 'scheduledAt', label: 'Lịch phỏng vấn', type: 'datetime', required: true, width: '50', tableWidth: 190 }, { key: 'interviewerStaffIds', label: 'Người phỏng vấn', type: 'multi-select', width: '50', tableWidth: 240 }, { key: 'location', label: 'Địa điểm / link họp', width: '50', tableWidth: 240 }, { key: 'status', label: 'Trạng thái', type: 'select', defaultValue: 'SCHEDULED', options: [{ value: 'SCHEDULED', label: 'Đã lên lịch' }, { value: 'COMPLETED', label: 'Đã phỏng vấn' }, { value: 'CANCELLED', label: 'Đã hủy' }], width: '33', tableWidth: 150 }, { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'recruitment-scorecards': [
    { key: 'candidateApplicationId', label: 'Hồ sơ ứng tuyển', required: true, width: '50', tableWidth: 220 }, { key: 'recruitmentInterviewId', label: 'Buổi phỏng vấn', width: '50', tableWidth: 220 }, { key: 'interviewerStaffId', label: 'Người đánh giá', required: true, width: '50', tableWidth: 200 }, { key: 'technicalRating', label: 'Chuyên môn (1-5)', type: 'number', width: '25', tableWidth: 150 }, { key: 'serviceRating', label: 'Dịch vụ (1-5)', type: 'number', width: '25', tableWidth: 150 }, { key: 'attitudeRating', label: 'Thái độ (1-5)', type: 'number', width: '25', tableWidth: 150 }, { key: 'overallRating', label: 'Tổng điểm (1-5)', type: 'number', required: true, width: '25', tableWidth: 150 }, { key: 'recommendation', label: 'Khuyến nghị', type: 'select', required: true, options: [{ value: 'YES', label: 'Nên tiếp tục' }, { value: 'NO', label: 'Không nên tiếp tục' }, { value: 'HOLD', label: 'Cần trao đổi thêm' }], width: '33', tableWidth: 180 }, { key: 'note', label: 'Nhận xét', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'recruitment-offers': [
    { key: 'code', label: 'Mã đề nghị', required: true, width: '33', tableWidth: 150 }, { key: 'candidateApplicationId', label: 'Hồ sơ ứng tuyển', required: true, width: '50', tableWidth: 220 }, { key: 'offeredSalary', label: 'Lương đề nghị', type: 'number', width: '33', tableWidth: 180 }, { key: 'proposedStartDate', label: 'Ngày dự kiến nhận việc', type: 'date', width: '50', tableWidth: 190 }, { key: 'status', label: 'Trạng thái', type: 'select', defaultValue: 'DRAFT', options: [{ value: 'DRAFT', label: 'Nháp' }, { value: 'SENT', label: 'Đã gửi' }, { value: 'ACCEPTED', label: 'Đã nhận' }, { value: 'DECLINED', label: 'Từ chối' }], width: '33', tableWidth: 150 }, { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'asset-categories': [
    { key: 'code', label: 'Mã danh mục', required: true, width: '33', tableWidth: 150 }, { key: 'name', label: 'Tên danh mục', required: true, width: '50', tableWidth: 240 }, { key: 'requiresSerial', label: 'Yêu cầu serial', type: 'checkbox', width: '33', tableWidth: 140 }, { key: 'maintenanceRequired', label: 'Cần bảo trì', type: 'checkbox', width: '33', tableWidth: 140 }, { key: 'depreciationEnabled', label: 'Khấu hao', type: 'checkbox', width: '33', tableWidth: 130 }, { key: 'isActive', label: 'Đang sử dụng', type: 'checkbox', defaultValue: true, width: '33', tableWidth: 150 }, { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  assets: [
    { key: 'code', label: 'Mã tài sản / QR', required: true, width: '33', tableWidth: 170 }, { key: 'name', label: 'Tên tài sản', required: true, width: '50', tableWidth: 240 }, { key: 'assetCategoryId', label: 'Danh mục', required: true, width: '50', tableWidth: 190 }, { key: 'serialNumber', label: 'Serial', width: '33', tableWidth: 160 }, { key: 'model', label: 'Model', width: '33', tableWidth: 160 }, { key: 'branchId', label: 'Chi nhánh', width: '50', tableWidth: 180 }, { key: 'warehouseId', label: 'Kho', width: '50', tableWidth: 180 }, { key: 'roomId', label: 'Phòng', width: '50', tableWidth: 180 }, { key: 'custodianStaffId', label: 'Người chịu trách nhiệm', width: '50', tableWidth: 220 }, { key: 'purchaseDate', label: 'Ngày mua', type: 'date', width: '33', tableWidth: 150 }, { key: 'purchaseCost', label: 'Nguyên giá', type: 'number', width: '33', tableWidth: 160 }, { key: 'warrantyUntil', label: 'Bảo hành đến', type: 'date', width: '33', tableWidth: 160 }, { key: 'status', label: 'Tình trạng', type: 'select', defaultValue: 'AVAILABLE', options: [{ value: 'AVAILABLE', label: 'Sẵn sàng' }, { value: 'ASSIGNED', label: 'Đã bàn giao' }, { value: 'MAINTENANCE', label: 'Đang bảo trì' }, { value: 'OUT_OF_SERVICE', label: 'Ngừng hoạt động' }, { value: 'DISPOSED', label: 'Đã thanh lý' }], width: '33', tableWidth: 160 }, { key: 'note', label: 'Ghi chú', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'asset-movements': [
    { key: 'code', label: 'Mã phiếu', width: '33', tableWidth: 150 }, { key: 'assetId', label: 'Tài sản', required: true, width: '50', tableWidth: 230 }, { key: 'movementType', label: 'Loại phiếu', type: 'select', required: true, options: [{ value: 'TRANSFER', label: 'Điều chuyển' }, { value: 'ASSIGN', label: 'Bàn giao' }, { value: 'RETURN', label: 'Thu hồi' }, { value: 'REPORT_DAMAGE', label: 'Báo hỏng' }, { value: 'DISPOSE', label: 'Thanh lý' }], width: '33', tableWidth: 170 }, { key: 'movementAt', label: 'Thời điểm', type: 'datetime', required: true, width: '50', tableWidth: 190 }, { key: 'toBranchId', label: 'Chi nhánh đích', width: '50', tableWidth: 180 }, { key: 'toWarehouseId', label: 'Kho đích', width: '50', tableWidth: 180 }, { key: 'toRoomId', label: 'Phòng đích', width: '50', tableWidth: 180 }, { key: 'toCustodianStaffId', label: 'Người nhận', width: '50', tableWidth: 220 }, { key: 'note', label: 'Ghi chú / biên bản', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'asset-maintenances': [
    { key: 'code', label: 'Mã bảo trì', required: true, width: '33', tableWidth: 150 }, { key: 'assetId', label: 'Tài sản', required: true, width: '50', tableWidth: 230 }, { key: 'maintenanceType', label: 'Loại', type: 'select', options: [{ value: 'PREVENTIVE', label: 'Bảo trì định kỳ' }, { value: 'REPAIR', label: 'Sửa chữa' }, { value: 'CALIBRATION', label: 'Hiệu chuẩn' }], required: true, width: '33', tableWidth: 170 }, { key: 'scheduledDate', label: 'Ngày dự kiến', type: 'date', required: true, width: '33', tableWidth: 150 }, { key: 'completedDate', label: 'Ngày hoàn tất', type: 'date', width: '33', tableWidth: 150 }, { key: 'assigneeStaffId', label: 'Người phụ trách', width: '50', tableWidth: 220 }, { key: 'supplierId', label: 'Nhà cung cấp', width: '50', tableWidth: 220 }, { key: 'cost', label: 'Chi phí', type: 'number', width: '33', tableWidth: 160 }, { key: 'status', label: 'Trạng thái', type: 'select', defaultValue: 'SCHEDULED', options: [{ value: 'SCHEDULED', label: 'Đã lên lịch' }, { value: 'IN_PROGRESS', label: 'Đang thực hiện' }, { value: 'COMPLETED', label: 'Hoàn tất' }, { value: 'CANCELLED', label: 'Đã hủy' }], width: '33', tableWidth: 150 }, { key: 'note', label: 'Nội dung', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  treatments: [
    { key: 'customerId', label: 'Khách hàng', required: true, width: '50', tableWidth: 220 },
    { key: 'branchId', label: 'Chi nhánh', required: true, width: '50', tableWidth: 190 },
