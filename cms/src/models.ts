...
export const baseFields: Record<string, FieldSpec[]> = {
  ...
  'workflow-definitions': [
    ...
    { key: 'targetResource', label: 'Loại chứng từ', required: true, width: '50', tableWidth: 220 },
    { key: 'isActive', label: 'Đang dùng', width: '25', tableWidth: 120 },
    { key: 'submitStatuses', label: 'Status bắt đầu flow', type: 'multi-select', options: [{ value: 'pending', label: 'pending' }, { value: 'submitted', label: 'submitted' }, { value: 'draft', label: 'draft' }], width: '50', tableWidth: 220 },
    { key: 'approvedStatus', label: 'Status khi duyệt xong', width: '33', tableWidth: 170 },
    { key: 'rejectedStatus', label: 'Status khi từ chối', width: '33', tableWidth: 160 },
    { key: 'cancelledStatus', label: 'Status khi hủy', width: '33', tableWidth: 150 },
    { key: 'description', label: 'Mô tả', type: 'textarea', width: '100', tableWidth: 320 },
  ],
  'workflow-steps': [
