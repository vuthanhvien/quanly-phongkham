...
import { Appointment, AppUiSetting, BranchRoleAssignment, ChatbotSetting, Customer, CustomFieldDefinition, CustomTable, CustomTableColumn, CustomTableRow, DynamicRoleDefinition, ItemCategory, LandingDomain, LandingForm, LandingFormSubmission, LandingGlobalSetting, LandingPage, LandingThemeSetting, PrintTemplate, Product, Staff, Treatment, Unit, User, ViewSetting, WorkSchedule } from '../entities/entities';
...
@Module({
  imports: [TenantOrmModule.forFeature([CustomFieldDefinition, CustomTable, CustomTableColumn, CustomTableRow, ViewSetting, PrintTemplate, DynamicRoleDefinition, User, BranchRoleAssignment, LandingPage, LandingDomain, LandingForm, LandingFormSubmission, AppUiSetting, ChatbotSetting, LandingThemeSetting, LandingGlobalSetting, Treatment, Appointment, WorkSchedule, Customer, Staff, Unit, ItemCategory, Product]), RecordsModule],
